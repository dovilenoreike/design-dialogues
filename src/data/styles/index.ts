...
export const styles: Style[] = [
  ...
  },
  {
    ...
    promptSnippet: "Take inspiration from Japandi interiors, an syntheses of Japanese Wabi-Sabi and Scandinavian minimalism, and create a modern, tranquil atmosphere. Avoid rustic or heavy elements — keep the mood elevated, airy, and contemporary. Add some of well chosen items such as vases or other decor elements inspired by Japanese aesthetics. References: Kinfolk, Cereal Magazine, Casa BRUTUS."
  },
  {
