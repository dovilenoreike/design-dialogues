...
export const collectionsV2: CollectionV2[] = [
  ...
  },
  {
    ...
    pool: {
      ...
      "cabinet-fronts":          [ "white", "dark-wood",],
      walls:                     ["off-white"],
      accents:                   ["wine-red", "aged-bronze"],
    },
    products: {
      flooring:                  { "light-wood": ["solido-bolsena"], "dark-wood": ["aspecta-maggiore"], "concrete": ["solido-pearl"] },
      "worktops-and-backsplashes": { "bold-texture-light": ["fondi-32-vento-marmo"] },
      "cabinet-fronts":          { "dark-wood": ["alvi-goya-03-na"], "white": ["off-white-matte"] },
  ...
  },
  {
    ...
    products: {
      flooring:                  { "light-wood": ["solido-bolsena"],  "medium-wood": ["aspecta-brienz"], "concrete": ["solido-pearl"] },
      "worktops-and-backsplashes": { "soft-texture-dark": ["icono-marquina-cava"], "concrete": ["icono-sereno-noto"] },
      "cabinet-fronts":          { "medium-wood": ["egger-brown-casella-oak"], "black": ["skin-carbon-fumo"], "neutral": ["velvet-1551"], "metallic": ["pearl-7901"] },
  ...
  },
  {
    ...
    pool: {
      ...
      "cabinet-fronts":          ["dark-wood", "pastel", "light-wood"],
      tiles:                     ["light-warm-concrete", "medium-warm-concrete"],
      walls:                     ["off-white"],
      accents:                   ["aged-bronze"],
    },
    products: {
      flooring:                  { "light-wood": ["constance-chevrone"], "concrete": ["solido-pearl"] },
      "worktops-and-backsplashes": { "soft-texture-dark": ["egger-f244-st76"] },
      "cabinet-fronts":          { "dark-wood": ["egger-dark-grey-fineline"], "pastel": ["velvet-3301"] , "light-wood": ["egger-medium-grey-fineline"]},
  ...
  },
  {
    ...
    products: {
      flooring:                  {  "light-wood": ["aspecta-baron"], "concrete": ["florim-sensi-lithos-white"] },
  ...
  },
  {
    ...
    products: {
      flooring:                  {  "medium-wood": ["aspecta-brienz"], "light-wood": ["solido-bolsena"], "concrete": ["solido-pearl"] },
...

  {
    ...
    pool: {
      flooring:                  [ "dark-wood", "concrete"],
      "worktops-and-backsplashes": ["bold-texture-light", "soft-texture-medium"],
      "cabinet-fronts":          ["black", "dark-wood", "metallic"],
      walls:                     ["off-white"],
      accents:                   ["aged-bronze", "gold"],
    },
    products: {
      flooring:                  {  "dark-wood": ["aspecta-burned"], "concrete": ["solido-pearl"] },
      "worktops-and-backsplashes": { "bold-texture-light": ["icono-laurent-carrata"], "soft-texture-medium": ["icono-picasso-marrone"] },
      "cabinet-fronts":          { "black": ["valchromat-black"], "dark-wood": ["egger-dark-brown-eucalypthus"], "metallic": ["pearl-7901"] },
      accents:                   { "aged-bronze": ["aged-bronze"], "gold": ["gold"] },
    },
  },
];
